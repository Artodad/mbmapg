import{a as e,g as t,h as n,i as r,m as i,o as a,p as o,r as s,s as c,u as l}from"./cart.BLEb0-mr.js";function u(e){return e.replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`)}var d=document.getElementById(`cart-app`);if(d){let f=d.dataset.shop??`/mbmapg/shop`,p=d.dataset.checkout??`/mbmapg/checkout`;function m(){if(!d)return;let h=a();if(h.items.length===0){d.innerHTML=`<p class="cart-empty">Your order list is empty. <a href="${f}">Back to shop</a></p>`;return}d.innerHTML=`
